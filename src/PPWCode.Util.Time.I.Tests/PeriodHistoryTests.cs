...
public abstract class PeriodHistoryTests<TPeriod, T>
    ...
    where T : struct, IComparable<T>, IEquatable<T>
{
    ...
    [SuppressMessage("StyleCop.CSharp.SpacingRules", "SA1010:Opening square brackets should be spaced correctly", Justification = "Tests")]
    public TPeriod[] GeneratePeriods(
        T startDate,
